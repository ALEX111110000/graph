...
class SEDR(nn.Module):
    def __init__(self, input_dim, params):
        ...
        self.encoder.add_module('encoder_fc1', full_block(input_dim, params.feat_hidden1, params.p_drop))  #*
        self.encoder.add_module('encoder_fc2', full_block(params.feat_hidden1, params.feat_hidden2, params.p_drop)) #*feat_hidden2才是feat_x维度。
